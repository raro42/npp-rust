...
## Handoff (2026-08-31)
- User-facing notes already in `docs/changelog.md` under **[0.3.8]** (not Unreleased).
- Task goal met: file drop open, selection drag move/copy with Ctrl/Cmd (v0.3.8, `4f79398`).
- Close issue #10 with `agent:done`.
