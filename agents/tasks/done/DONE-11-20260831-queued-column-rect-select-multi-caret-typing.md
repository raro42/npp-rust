...
## Handoff (2026-08-31)
- User-facing notes already in `docs/changelog.md` under **[0.3.9]** (not Unreleased).
- Task goal met: Alt+drag rect select, multi-caret typing/edits, Column Editor kept, docs `docs/column-mode.md` (v0.3.9, `569747b`).
- Close issue #11 with `agent:done`.
