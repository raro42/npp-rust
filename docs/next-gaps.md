# Next gaps (post v0.3.11)

Date: 2026-08-31  
Status: Issue **#8**–**#11** closed. **#12** TEST passed (await handoff). **#13** coder → TEST. Open: **#14**.
...
- v0.3.11: Autosave interval + backup-on-save (#13 coder)
...
| [13](https://github.com/raro42/npp-rust/issues/13) | P1 | Autosave / backup-on-save — TEST |
